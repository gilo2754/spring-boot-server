INSERT INTO application (application_id, app_name, description, owner) VALUES (2, 'Trackzilla','A bug tracking application', 'Kesha Williams');
...
INSERT INTO user(user_id, user_name, user_surname) VALUES (1,'Paco','Lopez');