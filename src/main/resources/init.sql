...
-- Patients:
INSERT INTO _user  (user_id, role, first_name, last_name, email, phone_number, date_of_birth, social_number, username, password)
...
-- Doctors:
INSERT INTO _user  (user_id, role, first_name, last_name, email, phone_number, date_of_birth, speciality, clinic_id, username, password)
